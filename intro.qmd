...
3. Open "Intro.ipynb" that you downloaded in step 1
...
9. Remove the sentence to restore the cell to it's previous state.
...
3. Add simple commments next to each line explaining the code.
