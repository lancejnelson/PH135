...
3. A prime number is not the product of two smaller numbers. (i.e it is only evenly divisible by itself and 1) 
    
    1. Use a `for` loop to generate a list containing the first 100 prime numbers.
    2. Use a `while` loop to generate a list containing the first 100 prime numbers.
