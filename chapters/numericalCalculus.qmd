...
![Illustration of center-difference derivative on a discrete grid. Using array slicing the slope can be calculated at all points simultaneously.](https://lancejnelson.github.io/PH135/figures/centerdifference.png){fig-align="center"}
...
3. [This file](https://lancejnelson.github.io/PH135/files/Redbull_jump_full.ipynb) contains data from Felix Baumgartner's 2012 jump from an altitude of $39$ km above the surface of the earth.  Complete the following:
   ...
   5. The original data set has a column that contains the Felix's speed and the y-component of his acceleration. Plot this column vs. time and compare to the derivatives you performed to see if they match (or are close).


4. [This file](https://lancejnelson.github.io/PH135/files/Redbull_jump_full.ipynb) contains data from Felix Baumgartner's 2012 jump from an altitude of $39$ km above the surface of the earth.  Complete the following:

   1. Read the data file into a pandas dataframe.
   2. Plot the y-component of acceleration vs. time.
   3. Using rectangles, calculate the indefinite integral of this data. 
   4. Repeat step 3 but with trapezoids this time.
   5. Plot the integral vs time.  You may recall that the integral of acceleration is velocity (or rather the change in velocity).  Does the plot look right.
   6. The original data set has a column that contains the Felix's speed. Plot this column vs. time and compare to the integral you performed to see if they match (or are close).